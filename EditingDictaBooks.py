...
from PyQt6.QtWidgets import (
    ...
    QProgressBar, QScrollArea, QLayout, QFileDialog, QLineEdit, QMessageBox, 
    QComboBox, QHBoxLayout, QProgressDialog, QCheckBox, QTextEdit, QDialog, 
    QFrame, QSplitter, QGridLayout, QSpacerItem, QSizePolicy, QProxyStyle, QTextBrowser, 
    QTreeWidget
)
from PyQt6.QtCore import (
    Qt, pyqtSignal, QThread, QTimer, QPropertyAnimation, QEasingCurve,
    QBuffer, QIODeviceBase
)
from PyQt6.QtGui import (
    QIcon, QPixmap, QCursor, QColor, QPalette, QTextDocument, 
    QFont, QTextOption, QTextCursor, QKeySequence
)
...
if __name__ == "__main__":
    # הגדרת High DPI לפני יצירת האפליקציה
    if hasattr(Qt, 'HighDpiScaleFactorRoundingPolicy'):
        QApplication.setHighDpiScaleFactorRoundingPolicy(
            Qt.HighDpiScaleFactorRoundingPolicy.PassThrough)
            
    # הגדרת AppUserModelID עם ctypes במקום QtWin
    myappid = 'MIT.LEARN_PYQT.dictatootzaria'
    try:
        ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(myappid)
    except Exception:
        pass  # התעלם משגיאות אם הפונקציה לא זמינה
    
    # יצירת האפליקציה
    app = QApplication(sys.argv)
    
    # הגדרות נוספות ל-High DPI
    if hasattr(Qt.ApplicationAttribute, 'AA_EnableHighDpiScaling'):
        app.setAttribute(Qt.ApplicationAttribute.AA_EnableHighDpiScaling, True)
    if hasattr(Qt.ApplicationAttribute, 'AA_UseHighDpiPixmaps'):
        app.setAttribute(Qt.ApplicationAttribute.AA_UseHighDpiPixmaps, True)
    
    # הגדרת פקטור מידה לפי ברירת המחדל של המסך
...
class CreateHeadersOtZria(QWidget):
    ...
    def init_ui(self):
        ...
        search_container.addWidget(search_label, alignment=Qt.AlignmentFlag.AlignCenter)
        search_container.addWidget(self.level_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        end_container.addWidget(end_label, alignment=Qt.AlignmentFlag.AlignCenter)
        end_container.addWidget(self.end_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        heading_container.addWidget(heading_label, alignment=Qt.AlignmentFlag.AlignCenter)
        heading_container.addWidget(self.heading_level_var, alignment=Qt.AlignmentFlag.AlignCenter)
...
class CreateSingleLetterHeaders(QWidget):
    ...
    def init_ui(self):
        ...
        start_container.addWidget(start_label, alignment=Qt.AlignmentFlag.AlignCenter)
        start_container.addWidget(self.start_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        end_container.addWidget(end_label, alignment=Qt.AlignmentFlag.AlignCenter)
        end_container.addWidget(self.finde_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        heading_container.addWidget(heading_label, alignment=Qt.AlignmentFlag.AlignCenter)
        heading_container.addWidget(self.level_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        layout.addWidget(self.bold_var, alignment=Qt.AlignmentFlag.AlignCenter)
        # התעלם מהתווים
        ...
        ignore_container.addWidget(ignore_label, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        remove_container.addWidget(remove_label, alignment=Qt.AlignmentFlag.AlignCenter)
...
class ChangeHeadingLevel(QWidget):
    ...
    def init_ui(self):
        ...
        current_level_container.addWidget(current_level_label, alignment=Qt.AlignmentFlag.AlignCenter)
        current_level_container.addWidget(self.current_level_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        new_level_container.addWidget(new_level_label, alignment=Qt.AlignmentFlag.AlignCenter)
        new_level_container.addWidget(self.new_level_var, alignment=Qt.AlignmentFlag.AlignCenter)
...
class EmphasizeAndPunctuate(QWidget):
    ...
    def init_ui(self):
        ...
        ending_container.addWidget(ending_label, alignment=Qt.AlignmentFlag.AlignCenter)
        ending_container.addWidget(self.ending_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        layout.addWidget(self.emphasize_var, alignment=Qt.AlignmentFlag.AlignCenter)
        # כפתור הפעלה
        button_container = QHBoxLayout()
        run_button = QPushButton("הפעל")
        run_button.clicked.connect(self.run_script)
...
class CreatePageBHeaders(QWidget):
    ...
    def init_ui(self):
        ...
        header_type_container.addWidget(header_type_label, alignment=Qt.AlignmentFlag.AlignCenter)
        header_type_container.addWidget(self.header_type_var, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        level_container.addWidget(level_label, alignment=Qt.AlignmentFlag.AlignCenter)
        level_container.addWidget(self.level_var, alignment=Qt.AlignmentFlag.AlignCenter)
...
class ReplacePageBHeaders(QWidget):
    ...
    def init_ui(self):
        ...
        """)
        attention.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        replace_container.addWidget(replace_label, alignment=Qt.AlignmentFlag.AlignCenter)
        replace_container.addWidget(self.replace_type, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        """)
        example1.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        """)
        example2.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
class בדיקת_שגיאות_בכותרות(QWidget):
    ...
    def init_ui(self):
        ...
        re_start_label.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        self.re_start_entry = QLineEdit()
        self.re_start_entry.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        
        re_end_label = QLabel("תו/ים בסוף הכותרת:")
        self.re_end_entry = QLineEdit()
        self.re_end_entry.setAlignment(Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
...
class ImageToHtmlApp(QWidget):
    def __init__(self):
        ...
        self.convert_btn = QPushButton("המר")
        ...
        self.nextInFocusChain.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        self.copy_btn = QPushButton("העתק")
        ...
        self.cop.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
class TextCleanerApp(QWidget):
    ...
    def initUI(self):
        ...
        action_buttons_container.addWidget(self.cleanBtn, alignment=Qt.AlignmentFlag.AlignCenter)
        action_buttons_container.addWidget(self.undoBtn, alignment=Qt.AlignmentFlag.AlignCenter)
...
class MainMenu(QMainWindow):
    ...
    def init_ui(self):
        ...
        buttons_grid_widget.setSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        add_file_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        edit_in_notepad_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        ...
        update_button.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
    ...
    def update_navigation_menu(self):
        ...
        print("תהליך ניתוח כותרות התחיל")  
    ...
    def save_file(self):
        """שמירת הקובץ תוך שימור תגי HTML"""
        if not self.current_file_path:
            return
                
        try:
            # בדיקה אם יש מצב שמור בהיסטוריה
            if self.current_index >= 0 and self.current_index < len(self.document_history):
                ...
                # הסרת תגי המעטפת של Qt
                if '<!DOCTYPE' in html_content:
                    body_start = html_content.find("<body")
                    body_end = html_content.find("</body>")
                    if body_start != -1 and body_end != -1:
                        content = html_content[body_start:body_end + 7]
                        
                # הסרת תגים מיותרים שנוספו על ידי Qt
                content = content.replace('<body style=" font-family:\'MS Shell Dlg 2\'; font-size:8.25pt; font-weight:400; font-style:normal;">', '')
                ...
                # הסרת תכונות style שנוספו אוטומטית
    ...
    def _clean_display_tags(self, html_content):
        """ניקוי תגי HTML מיותרים והשארת רק התגים החיוניים"""
        try:
            # רשימת התגים החיוניים בלבד
            essential_tags = {
                'h1', 'h2', 'h3', 'h4', 'h5', 'h6',  # כותרות
                'b', 'i', 'u',                        # עיצוב בסיסי
                'sup', 'sub'                          # טקסט עילי ותחתי
            }
            
            # 1. ניקוי תגי span
            html_content = re.sub(r'<span[^>]*>(.*?)</span>', r'\1', html_content, flags=re.DOTALL)
            
            # 2. הסרת תכונות align מכל התגים
            html_content = re.sub(r'(<[^>]+) align="[^"]*"([^>]*>)', r'\1\2', html_content)
            
            # 3. שמירת תגים חיוניים
            preserved_content = {}
            for tag in essential_tags:
                pattern = f'<{tag}[^>]*>(.*?)</{tag}>'
                matches = re.finditer(pattern, html_content, re.DOTALL)
                for i, match in enumerate(matches):
                    key = f'PRESERVE_{tag}_{i}'
                    preserved_content[key] = f'<{tag}>{match.group(1)}</{tag}>'
                    html_content = html_content.replace(match.group(0), key)
            # 4. הסרת כל תגי HTML אחרים
            html_content = re.sub(r'<[^>]+>', '', html_content)
            # 5. החזרת התגים החיוניים
            for key, value in preserved_content.items():
                html_content = html_content.replace(key, value)
            # 6. ניקוי רווחים מיותרים
            html_content = re.sub(r'\n\s*\n', '\n', html_content)    # מרווחים בין פסקאות
            html_content = re.sub(r' +', ' ', html_content)          # רווחים כפולים
            html_content = re.sub(r'^\s+', '', html_content, 
                                flags=re.MULTILINE)                   # רווחים בתחילת שורות
            html_content = re.sub(r'\s+$', '', html_content, 
                                flags=re.MULTILINE)                   # רווחים בסוף שורות
            ...
            print(f"שגיאה בניקוי תגי HTML: {str(e)}")
            return html_content
        ...
        try:
            ...
            if not os.path.exists(updater_path):
                try:
                    ...
                    updater_window.setWindowFlags(Qt.WindowType.Dialog | Qt.WindowType.MSWindowsFixedSizeDialogHint)
                    updater_window.setLayoutDirection(Qt.LayoutDirection.RightToLeft)
                    ...
                    """)
                    main_status.setAlignment(Qt.AlignmentFlag.AlignCenter)
                    ...
                    """)
                    detail_status.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
class AboutDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        info_container.addWidget(version_label, alignment=Qt.AlignmentFlag.AlignCenter)
        info_container.addWidget(date_label, alignment=Qt.AlignmentFlag.AlignCenter)
        ...
        mitmachimtop_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
        ...
        gmail_label.setAlignment(Qt.AlignmentFlag.AlignCenter)
...
def main():
    ...
    # הגדרת AppUserModelID עבור Windows
    if sys.platform == 'win32':
        try:
            ctypes.windll.shell32.SetCurrentProcessExplicitAppUserModelID(myappid)
        except Exception:
            pass  # מתעלם משגיאות אם הפונקציה לא זמינה
